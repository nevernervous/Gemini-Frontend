 ...
 */
const TBODY_SINGLE_ROW_HEIGHT = 45;

  /**
   * Controller for a single calendar month.
   * ngInject @constructor
   */
class UalCalendarMonthController {
  /*@ngInject*/
  constructor($element, $scope, $animate, $q,
    ...
    this.prevClickHandler = function(date) {
      return function() { self.changeDisplayDate(date); };
    };

    this.nextClickHandler = function(date) {
      return function() { self.changeDisplayDate(date); };
    };
  }
...
export default UalCalendarMonthController;
