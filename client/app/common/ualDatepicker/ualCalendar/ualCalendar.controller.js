...
class UalCalendarController {
  /*@ngInject*/
  constructor($element, $scope, $$mdDateUtil, $mdUtil,
   ...
   */
  hideVerticalScrollbar(childCtrl) {
    var self = this;
...
export default UalCalendarController;
